export function getImprovedFeedback(question: string, answer: string): any {
  const answerLength = answer.length;
  const answerLower = answer.toLowerCase();
  
  // STAR Method Detection (ultra-strict)
  // Situation: Must have context, background, or specific situation description
  ...
  // Task: Must have clear goal, objective, or responsibility
  ...
  // STAR Method scoring (most important)
